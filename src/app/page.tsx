        ...
        <div className="w-screen h-fit p-4">
            ...
            <div className="relative border-4 border-neutral-300">
                <div className="absolute top-0 flex">
                    <button onClick={e => {}} className="paragraph">
                        <svg
                    ...
                    <button onClick={handleClick} className="italic">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="quote">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="ol">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="ul">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="code">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="hr">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="image">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="braces">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                    ...
                    <button onClick={handleClick} className="highlighter">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
